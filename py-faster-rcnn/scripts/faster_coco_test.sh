...
#NET_FINAL="/state/partition1/javier/output/faster_rcnn_end2end/train/pose_cls_15k250k5k_dyp__iter_10000.caffemodel"
...
time ./tools/test_net.py --gpu ${GPU_ID} \
  --def models/modelpose/${NET}/faster_rcnn_end2end/test.final.prototxt \
  --net ${NET_FINAL} \
  --imdb ${TEST_IMDB} \
