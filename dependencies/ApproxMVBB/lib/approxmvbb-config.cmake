...
find_path(ApproxMVBB_INCLUDE_DIR NAMES "ApproxMVBB/Config/Config.hpp" HINTS /usr/local/include ${ApproxMVBB_DIR})
message(STATUS "ApproxMVBB include dir:  " ${ApproxMVBB_INCLUDE_DIR})

#Find libraries in 
find_library(ApproxMVBB_LIBRARY_REL NAMES "ApproxMVBB" HINTS /usr/local/lib ${ApproxMVBB_DIR} NO_DEFAULT_PATH)
find_library(ApproxMVBB_LIBRARY_DBG NAMES "ApproxMVBB-dbg" HINTS /usr/local/lib ${ApproxMVBB_DIR} NO_DEFAULT_PATH)
