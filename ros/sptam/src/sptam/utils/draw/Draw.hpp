...
template<class T>
void drawProjections(cv::Mat& image, const cv::Matx34d& projection,  const T& points, const cv::Scalar& color = COLOR_BLUE);

template<class T>
void drawOBB(cv::Mat& image,const cv::Matx34d& projection, const T& points,const std::string& clase, const cv::Scalar& color = COLOR_BLUE);
